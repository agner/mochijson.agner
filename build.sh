...
rm -rf examples scripts support Makefile README rebar.config src/internal.hrl src/mochilogfile2.erl src/mochiweb_cookies.erl src/mochiweb_request.erl src/mochifmt.erl src/mochiweb_cover.erl src/mochiweb_request_tests.erl \
       ...
       src/mochiweb_html.erl src/mochiweb_socket.erl src/mochihex.erl src/mochiweb.erl src/mochiweb_http.erl src/mochiweb_socket_server.erl src/mochiweb_acceptor.erl src/mochiweb_io.erl src/mochiweb_sup.erl \
...
cp $AGNER_PACKAGE_REPO/mochijson.app.src src
./rebar compile
